...
int main(){
    ...
    while(true){
        ...
        cout<<"5. RECUPERAR REGISTROS"<<endl;
        ...
        switch(opc){
            ...
            case 3: if(borrarRegistro()!=1) cout<<"ERROR DE ARCHIVO"<<endl;
                    ...
                    break;
            case 4: if(modificarFechaNacimiento()!=1) cout<<"ERROR DE ARCHIVO"<<endl;
                    else cout<<"REGISTRO MODIFICADO"<<endl;
                    break;
            ///case 5: recuperarRegistros();
                    break;
            case 0: return 0;
                    break;
        }
...
int Alumno::grabarEnDisco(int pos){
    FILE *pAlu;
    int escribio;
    if(pos==-1){
...
int modificarFechaNacimiento(){
    ...
    if(pos>=0){
        ...
        escribio=alu.grabarEnDisco(pos);
    }
    else{
        cout<<"NO EXISTE EL LEGAJO"<<endl;
        return -2;
...
void recuperarRegistros(){
    ...
    int pos=0;
    while(alu.leerDeDisco(pos)==1){
        if(alu.getEstado()==false){
            alu.setEstado(true);
            alu.grabarEnDisco(pos);
        }
        pos++;
    }
}
